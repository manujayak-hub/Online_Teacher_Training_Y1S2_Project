...
<header class="header">
    ...
    <ul >
      <div>
		...
		<img class="picture" src="Image/man.jpeg" alt="man" >
		...
		<div class="div4">
			...
			<form action="contact.php" method="post">
				...
				<p id="paragraph">
					...
					<input type="text" class="sname" name="sname"></br></br>
					
					<label for ="email">E-mail:</label>
					<input type="email" class="email" name="email"></br></br>
					
					Message</br>
					<textarea type="text" class="message" name="message" rows="5"></textarea>
			...
			<div class="div5" align="right" >
			<p class="para"><b>For further infromation</br>Call us:</br>
						<p class="callpara">034-2249600</br>
											076-7794833</br>
											071-2055265</br></b>
						</p>
			</p>
